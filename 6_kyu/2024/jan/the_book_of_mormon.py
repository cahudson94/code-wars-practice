...
def mormons(starting_number, reach, target, missions=0):
    if target > starting_number:
        return mormons(reach * starting_number + starting_number, reach, target, missions + 1)
    return missions

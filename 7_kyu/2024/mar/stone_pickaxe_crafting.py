...
Story: You want to create a giant mine shaft,
but your a little stingy with your iron and diamonds and would not mine out all of the stone with iron or diamond pickaxes.
Instead, you rely on less durable but cheaper stone pickaxes!
You will need a lot of stone pickaxes though as they break faster than diamond or iron ones,
so you need to find out how many stone pickaxes you can craft before you run out of sticks and cobblestones.
Unfortunately, your not an organized person, and you leave all of your materials into a single chest with random junk that you need to filter.
...
If the array has atleast 3 "Cobblestones" and 2 "Sticks" you can craft a singular stone pickaxe.
...
def stone_pick(arr):
    return min(2 * arr.count("Wood") + arr.count("Sticks") // 2, arr.count("Cobblestone") // 3)
